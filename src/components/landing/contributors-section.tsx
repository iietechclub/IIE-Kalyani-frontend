                    ...
                    <Tooltip>
                      <TooltipTrigger>
                        <a
                          ...
                          className="group/icon flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 bg-neutral-800- text-neutral-800 transition-all duration-200 hover:bg-gray-800- hover:text-white- sm:h-7 sm:w-7"
                          aria-label={`${student.name}'s GitHub`}
                        >
                          <LuGithub className="size-3 text-gray-700- group-hover/icon:text-white- sm:size-3.5" />
                        </a>
                      </TooltipTrigger>
                      <TooltipContent>{`${student.name}'s GitHub`}</TooltipContent>
                    </Tooltip>
                    <Tooltip>
                      <TooltipTrigger>
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group/icon flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-blue-500 transition-all duration-200 hover:bg-blue-600- hover:text-white- sm:h-7 sm:w-7"
                          aria-label={`${student.name}'s LinkedIn`}
                        >
                          <LuLinkedin className="size-3 text-gray-700- group-hover/icon:text-white- sm:size-3.5" />
                        </a>
                      </TooltipTrigger>
                      <TooltipContent>{`${student.name}'s LinkedIn`}</TooltipContent>
                    </Tooltip>
                  </div>
                </div>
              </StaggerItem>
